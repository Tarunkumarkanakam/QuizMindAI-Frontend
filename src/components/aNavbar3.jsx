            ...
            <nav className="bg-gradient-to-r from-slate-50 from-28% via-cyan-50 via-40% to-indigo-100 to-32% py-4">
                <div className="container mx-auto flex items-center justify-between px-4">
                    <div className="flex items-center">
                        <Link to="/admin"> {/* Add Link component to wrap the logoCircle */}
                            <motion.img
                                src={logoCircle}
                                alt="QuizMind AI"
                                className="w-10 h-10 md:w-12 md:h-12 lg:w-16 lg:h-16 mr-2 object-contain cursor-pointer"
                                initial={{ rotate: 0 }}
                        ...
                        >
                            <img
                                src={logoText}
                                alt="QuizMind AI"
                                className="h-4 md:h-7 lg:h-9 w-auto object-contain"
                            />
                        </motion.div>
                    </div>
                    <button
